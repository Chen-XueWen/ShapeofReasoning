...
def main() -> None:
    ...
    ap.add_argument("--features", default="data/processed/gpt-oss_120b_aime2022/graph_features.jsonl")
    ap.add_argument("--outdir", default="data/processed/analysis/gpt-oss_120b_aime2022_graph")
    ...
    feat_cols = [
        ...
        if c not in {"id", "score", "coverage", "n_pairs", "indices", "has_loop"}
